            ...
            <tr>
              ...
              <td colspan="2">
                <a-form-item
                  :labelCol="labelCol"
                  :wrapperCol="wrapperCol">
                  <a-input class="text" v-decorator="[ 'destination', validatorRules.destination]"/>
                </a-form-item>
              </td>
              <td>
                项目名称
              ...
              <td colspan="2">
                <a-form-item
                  :labelCol="labelCol"
                  :wrapperCol="wrapperCol">
                  <a-input class="text" v-decorator="[ 'projectName', validatorRules.projectName]"/>
                </a-form-item>
              </td>
            </tr>
            <tr>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          destination:{rules: [{ required: true, message: '请输入目的地!' }]},
    ...
    methods: {
      ...
      edit(record) {
        ...
        this.model.applyUserName = store.getters.userInfo.username
        ...
        this.visible = true
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model, 'projectName', 'destination', 'reason','departAddress'))
          //时间格式化
