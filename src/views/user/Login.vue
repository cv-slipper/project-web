  ...
  <div class='main'>
    ...
    <div class='main-inner'>
      <a-form :form='form' class='user-layout-login' ref='formLogin' id='formLogin'>
        ...
        <a-form-item>
          <!--        <a-input type='text' size='large' class='my-input'-->
          <!--                 style='position: fixed;top:10000000px'-->
          ...
          <a-input
            ...
            placeholder='用户名'
          >
            <a-icon slot='prefix' type='user' :style="{ color: 'rgba(255,255,255,1)' }" />
          </a-input>
        ...
        <a-row>
          <a-col :span='24'>
            <a-form-item>
              ...
              <!--              style='position: fixed;top:10000000px'-->
              <!--              placeholder='密码 '>-->
              <!--              <a-icon slot='prefix' type='lock' :style="{ color: 'rgba(255,255,255,1)' }" />-->
              <!--            </a-input>-->
          ...
          <a-col :span='16'>
            <a-form-item>
              <a-input
                ...
                class='my-input'
                placeholder='请输入验证码'>
                <a-icon slot='prefix' type='smile' :style="{ color: 'rgba(255,255,255,1)' }" />
              </a-input>
            </a-form-item>
          </a-col>
...
.main {
  ...
  .main-inner {
    width: 100%;
    height: 540px;
    background: url("../../assets/login-inner-bg.png") no-repeat;
...
.user-layout-login {
  ...
  button.login-button {
    ...
    height: 40px;
    width: 100%;
    background-image: -webkit-linear-gradient(top, #00B8FF, #0177E4) !important;
  }
...
/deep/ input:-webkit-autofill {
  box-shadow: 0 0 0 1000px #1B1F51 inset;
