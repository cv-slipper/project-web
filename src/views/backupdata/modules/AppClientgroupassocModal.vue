  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/appclientgroupassoc/appClientgroupassoc/add",
          edit: "/appclientgroupassoc/appClientgroupassoc/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'domain','clientGroupId','clientId'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'domain','clientGroupId','clientId'))
      },
