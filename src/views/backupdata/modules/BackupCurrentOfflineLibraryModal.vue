  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="库状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['libraryState']" placeholder="请输入库状态"></a-input>
        </a-form-item>
        ...
        <a-form-item label="驱动器状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['driverState']" placeholder="请输入驱动器状态"></a-input>
        </a-form-item>
...
<script>
  ...
  export default {
    name: "BackupCurrentOfflineLibraryModal",
    components: {
      JDictSelectTag
    },
    data () {
      return {
        ...
        url: {
          add: "/cvOfflineLibrary/add",
          edit: "/cvOfflineLibrary/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'handled','domain','library','libraryState','driver','model','driverState','reason'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'domain','library','libraryState','driver','model','driverState','reason'))
      },
