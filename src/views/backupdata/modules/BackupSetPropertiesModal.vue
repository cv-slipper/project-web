  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="totalBackupSize" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <a-form-item label="securityAssociations" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['securityAssociations']" placeholder="请输入securityAssociations"></a-input>
        </a-form-item>
        ...
        <a-form-item label="backupsetSecurity" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['backupsetSecurity']" placeholder="请输入backupsetSecurity"></a-input>
        </a-form-item>
        ...
        <a-form-item label="commonBackupSet" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['commonBackupSet']" placeholder="请输入commonBackupSet"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/backupsetproperties/backupSetProperties/add",
          edit: "/backupsetproperties/backupSetProperties/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'domain','clientId','backupsetId','modifiedTime','applicationSize','totalBackupSize','lastBackupTime','firstBackupTime','dedupeRatio','securityAssociations','content','backupsetSecurity','fsBackupSet','planEntity','commonBackupSet','backupSetEntity'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'domain','clientId','backupsetId','modifiedTime','applicationSize','totalBackupSize','lastBackupTime','firstBackupTime','dedupeRatio','securityAssociations','content','backupsetSecurity','fsBackupSet','planEntity','commonBackupSet','backupSetEntity'))
      },
