  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/viewplanentity/viewPlanEntity/add",
          edit: "/viewplanentity/viewPlanEntity/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'domain','userId','userName','storagePolicyId','storagePolicyName','planName','description'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'domain','userId','userName','storagePolicyId','storagePolicyName','planName','description'))
      },
