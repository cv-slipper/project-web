                ...
                <a-col :span="12">
                  <a-form-item label="" style="margin-bottom: 12px">
                    <a-input-group compact>
                      <a-input style=" width: 200px; text-align: center" placeholder="如：XXX.X.X.X" />
                      <a-input
                        style=" width: 30px; border-left: 0; pointer-events: none; backgroundColor: #fff"
                        placeholder="~"
                        disabled
                      />
                      <a-input style="width: 200px; text-align: center; border-left: 0" placeholder="如：XXX.X.X.X" />
                    </a-input-group>
                  </a-form-item>
                </a-col>
              </a-row>
  ...
  const data =  [
    {
      ...
      createTime: '2021-09-23 20:00:00',
    },
    {
      title: 'XXXXXXXXXXXXX',
      description: 'XXXXXXXXXXXXXX',
      createTime: '2021-09-24 13:54:15',
    },
    {
      title: 'XXXX',
      description: 'XXXXXXXXXXXXXX',
      createTime: '2018-09-23 20:00:00',
    },
    {
      title: 'XXXX',
      description: 'XXXXXXXXXXXXXX',
