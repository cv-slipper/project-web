<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="日期">
                <a-month-picker placeholder="请选择日期" format="YYYY-MM" v-model="queryParam.startTime"></a-month-picker>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" @click="handlePrint" icon="printer" style="margin-left: 8px">打印</a-button>
    ...
    <a-divider orientation="left" v-show="selectedRowKeys.length>0">
      明细
    </a-divider>
...
<script>
  ...
  export default {
    name: 'CostList',
    components:{ JDate, CostPieChart, CostHistogram,CostPrintModel },
    data(){
      return{
    ...
    methods:{
      ...
      showDetail(record){
        this.$router.push({path:'/backup/costmanage/CostList',query:{companyName:record.companyName,startTime:record.startTime}})
      },
      handlePrint(){
